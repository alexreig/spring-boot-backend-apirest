...
import springboot.backend.apirest.models.dao.IFacturaDao;
import springboot.backend.apirest.models.dao.IProductoDao;
...
import springboot.backend.apirest.models.entity.Producto;
...
public class ClienteServiceImpl implements IClienteService {
	...
	public List<Clase> findAllClases() {
		return clienteDao.findAllClases();
	}
